...
function show_medicica_form() {
	...
	print "<b>Amministrazione - Inserimento Medici Cardiologi:</b><br /><br /><br />";
	print "Codice: <input type='text' name='codmedicoca' size='10' maxlenght='10'/>";
	print "&nbsp;&nbsp;Medico Cardiologo: <input type='text' name='medicoca' size='100' maxlenght='250'/>";
	print "<br /><br />";
	print "</font>";
...
function exec_admin() { 
  connect_to_db();
	$codmedicoca = strtoupper($_POST["codmedicoca"]);
	$medicoca = $_POST["medicoca"];
	// registrazione dati del medico
	$sql = "insert into medici_ca(codmedicoca, medicoca) values(";
	$sql.="'$codmedicoca', '$medicoca')";
