...
<html>
<head>
<title>Inserimento Agende</title>
...
// Mostra la maschera per l'inserimento delle agende dei medici specialisti
function mostra_form_agende() {
	connect_to_db();
	?>
	<form name='ins_agende' method='POST' action='agende_ins.php'>
	<select name='ci'>
	<option value=''>- Selezionare lo specialista -</option>
	<?php
	// Selezione dello specialista di cui inserire le agende
